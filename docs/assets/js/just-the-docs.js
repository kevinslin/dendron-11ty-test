(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://11ty.dendron.so/bond/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://11ty.dendron.so/bond/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://11ty.dendron.so/bond/assets/css/just-the-docs-' + theme + ".css"
      );
    };
